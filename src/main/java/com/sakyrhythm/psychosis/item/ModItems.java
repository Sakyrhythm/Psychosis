...
public class ModItems {
    ...
    public static final Item DIVINECLOTH = registerItem("divinecloth", new Item(new Item.Settings()));
    ...
    public static final Item UMBRELLA = registerItem("umbrella", new UmbrellaItem(new Item.Settings().maxCount(1)));
